...
# projects.delete 为 P1：端点对所有人返回 403（PERMISSION_NOT_AVAILABLE）
DELETE|/api/projects/00000000-0000-0000-0000-000000000000|401|403|403|403|403|403|403
...
# 备份恢复端点已移除（PG 恢复走 pg_dump，OPS 职责）
POST|/api/backup/restore|401|404|404|404|404|404|404
EOF
)
