...
const navItems = [
  ...
  // 知识库（含子菜单）
  { path: '/docs', label: '知识库', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', children: [
    { path: '/knowledge/reagents', label: '试剂原料库' }
  ] },
  { path: '/reagent-formula', label: '试剂配方', icon: 'M6 3v12M18 3v12M3 15h18M3 21h18', },
  { path: '/reagent-formula/calculator', label: '配制计算器', icon: 'M12 8c-1.657 0-3 1.343-3 3v6h6v-6c0-1.657-1.343-3-3-3z' },
